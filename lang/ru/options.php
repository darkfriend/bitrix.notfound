<?php
$MESS["D2F_NOTFOUND_DONATE_MESSAGES"] = "Вы используете бесплатный модуль. Ваши донаты стимулируют скорость выпуска новых обновлений, а также новых бесплатных модулей. <a href='#LINK#' target='_blank'>Поддержать разработчиков</a>";

$MESS["LABEL_ADD"] = "Добавить";

$MESS["D2F_NOTFOUND_LABEL_ENABLE"] = "Активность";
$MESS["D2F_NOTFOUND_LABEL_TEMPLATE"] = "Текущий шаблон";
